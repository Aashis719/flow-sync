    ...
    <>
        ...
        <div className="flex items-center justify-between p-3 ">
          ...
          <div className='md:ml-5' >
            <a href="#root">
              ...
              <h1 className='text-xl  md:text-2xl font-semibold'>Flo<span className='text-purple-600'>W</span>Sync</h1>
            </a>
          </div>
      ...
      <div className="fixed top-0 right-0 w-50 h-full bg-white shadow-md flex flex-col items-left gap-6 pt-20 z-120 ">
        ...
        <div className='flex flex-col items-left gap-2 md:gap-10  '>
          <a href="#" className="text-xl font-semibold hover:text-gray-100 hover:bg-purple-500 px-4 py-2 duration-200 ease-in" onClick={toggleNavbar}>Home</a>
          ...
          <button className="py-2 px-4 text-white  text-sm font-semibold cursor-pointer bg-purple-500 hover:bg-purple-700" onClick={toggleNavbar}>
            <a href="#pricing">Get Started</a>
          </button>
        </div>
      )}
