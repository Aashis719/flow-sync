...
const testimonials = [
  {
    ...
    rating: 4,
    text: "It's been an amazing effort from the flowSync team to prioritise every request we've had and offer the best user experience. Looking forward to the continued growth of this association.",
  },
  {
    name: "Kavya Sharma",
  ...
  },
  {
    ...
    rating: 5,
    text: "Seamless experience and great support! FlowSync ensures our employees get the best services without any hassle.",
  }
  ,
  // {
  //   name: "Arjun Mehta",
